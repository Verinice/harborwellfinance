...
<head>
    ...
    <title>Application Update - Harborwell Finance</title>
    <style>
...
<body style="margin: 0; padding: 0; background-color: #f6f3f1;">
    <span style="display: none; font-size: 1px; line-height: 1px; max-height: 0; max-width: 0; opacity: 0; overflow: hidden;">
        Your Harborwell Finance application has been reviewed.
    </span>
                    ...
                    <tr>
                        <td class="px" style="padding: 32px 40px 0; font-family: 'Inria Sans', Arial, sans-serif; color: #20242B;">
                            ...
                            <p style="margin: 0 0 18px; font-size: 16px; line-height: 1.6; color: #5C616B;">
                                Hi {{ $application->full_name }}, thank you for your interest in Harborwell Finance. After careful review, we are unable to approve your application at this time.
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td class="px" style="padding: 0 40px 20px;">
                            <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                                <tr>
                                    <td style="background-color: #F5F5F7; border-radius: 16px; padding: 18px 20px;">
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
                                            <tr>
                                                <td style="font-family: 'Inria Sans', Arial, sans-serif; font-size: 14px; color: #4B505A; font-weight: 600;">
                                                    What happens next
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding-top: 8px; font-family: 'Inria Sans', Arial, sans-serif; font-size: 14px; color: #5C616B; line-height: 1.7;">
                                                    &bull; Review your status link for details and next steps.<br>
                                                    &bull; You are welcome to reapply if your circumstances change.<br>
                                                    &bull; Our support team can answer questions about the process.
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
